...
namespace Utilizr.Vpn
{
    public class Killswitch
    {
        ...
        const string NETLIB_DLL = "Netlib.dll";

        [DllImport(NETLIB_DLL, CallingConvention = CallingConvention.Cdecl)]
        ...
        public static extern bool KillswitchIsEngaged();
