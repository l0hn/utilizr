...
namespace Utilizr.VPN
{
    ...
    public interface IVPNController: IDisposable
    {
        ...
        void EndConnectAsync(IAsyncResult asyncResult);

        IAsyncResult ConnectAsync(IConnectionStartParams startParams, AsyncCallback callback = null);

        IAsyncResult DisconnectAsync(AsyncCallback callback = null);
        void EndDisconnectAsync(IAsyncResult asyncResult);

        IAsyncResult AbortAsync(AsyncCallback callback = null);
        void EndAbortAsync(IAsyncResult asyncResult);
